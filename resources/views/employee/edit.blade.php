    ...
    <div class="row">
        ...
        <form action="{{route('employee.update',$employee->id)}}" method="POST">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="name" value="{{$employee->name}}" name="name" required minlength="3" pattern="[A-Za-z]+" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <input type="tel" class="form-control" id="phone" value="{{$employee->phone}}" name="phone" required pattern="[0-9]{10}" />
